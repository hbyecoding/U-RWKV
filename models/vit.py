...
if __name__ == '__main__':
    ...
    x = torch.randn(3, 3, 224, 224)  # 输入 B C H W
    model = ViT(image_size=224, patch_size=16, num_classes=10, dim=768, depth=12, heads=12, mlp_dim=3072, channels=3, dim_head=64, dropout=0.1, emb_dropout=0.1)

    # print(model)
    log.add('test_del_vit_rwkv.log')
    log.info("vit for understand")
