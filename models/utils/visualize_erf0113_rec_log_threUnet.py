...
def load_model(model_path, device='cuda'):
    model = v_enc_256_fffse_dec_fusion_rwkv_with2x4(dims = [48,96,192,384,768])  # 初始化模型
...
def compute_erf(model, input_size=(256, 256), device='cuda'):
    ...
    valloader = get_dataloader(base_dir='/data/hongboye/projects/Tan9/data', dataset_num=1, img_size=256)
...
def heatmap(data, save_path, camp='Greens', figsize=(10, 10.75)):
...
def main():
    ...
    os.makedirs("visual_erf0223", exist_ok=True)
    heatmap(erf_with_brwkv, save_path='./visual_erf0223/PolyLoRA5x5_Brwkv_5_erf.png', camp='Greens')
