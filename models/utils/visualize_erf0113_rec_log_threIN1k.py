...
parser.add_argument('--source', default='./visual_save_npy0223/temp.npy', type=str, help='path to the contribution score matrix (.npy file)')
parser.add_argument('--data_path', default='/data/hongboye/dataset/IN1k', type=str, help='path to the IN1k ')
parser.add_argument('--heatmap_save', default='./visual_save_npy0223/heatmap.png', type=str, help='where to save the heatmap')
parser.add_argument("--save_path",default="./visual_save_npy0223/temp.npy",type=str)
