...
@register_model
def inceptionnext_nano(pretrained=False, **kwargs):
    model = MetaNeXt(depths=(3, 3, 27, 3), dims=(48, 96, 192, 384), 
                      token_mixers=InceptionDWConv2d,
                      **kwargs
    )
...
def inceptionnext_small(pretrained=False, **kwargs):
    model = MetaNeXt(depths=(1, 1, 1, 3), dims=(48, 96, 192, 384), 
                      token_mixers=InceptionDWConv2d,
                      **kwargs
    )
    model.default_cfg = default_cfgs['inceptionnext_small']
...
if __name__ == "__main__":
    ...
    model = inceptionnext_small().cuda()
