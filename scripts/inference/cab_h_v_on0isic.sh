...
for dataset in "${datasets[@]}"; do
    (
        result=$(CUDA_VISIBLE_DEVICES=0 python Tan9/main_vs_comp_cmunextN.py --dataset-name "$dataset" --batch-size 16 --epoch 280 --model vscan_enc_256_fffse_dec_fusion_rwkv2_h_v)
