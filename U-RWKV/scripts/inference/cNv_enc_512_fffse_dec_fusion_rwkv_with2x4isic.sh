...
# 定义模型名称
model="v_enc_512_fffse_dec_fusion_rwkv_with2x4"
...
for dataset in "${datasets[@]}"; do
    (
        result=$(CUDA_VISIBLE_DEVICES=4 python Tan9/main_vs_comp_cmunextN.py --dataset-name "$dataset" --batch-size 4 --epoch 280 --model "$model")
