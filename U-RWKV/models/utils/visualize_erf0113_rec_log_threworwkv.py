...
def load_model(model_path, device='cuda'):
    from src.network.conv_based.cval_LoRA5_enc_rwkv import v_enc_256_fffse_dec_fusion_rwkv_with2x4,v_enc_256_fffse_dec_fusion_rwkv_with2x4_wo
    
    # model = v_enc_256_fffse_dec_fusion_rwkv_with2x4()  # 初始化模型dims = [48,96,192,384,768]
    model = v_enc_256_fffse_dec_fusion_rwkv_with2x4_wo()
...
def main():
    ...
    # 加载模型（带 Brwkv 模块）
    model_path = '/data/hongboye/projects/checkpoint2025/v_enc_256_fffse_dec_fusion_rwkv_with2x4_wo/2025-02-24/249/isic18_3_BS_16_0.8162_v_enc_256_fffse_dec_fusion_rwkv_with2x4_wo_model.pth'
